...
<div id="page-" class="col-md-4 col-md-offset-4">
	<form class="form loginform" method="POST" action="authenticate.php" autocomplete="off">
		<div class="login-panel panel panel-default">
			...
			<div class="panel-body">
				...
				<?php } ?>
				<center><button type="submit" class="btn btn-success loginField" >Login</button></center>
			</div>
		</div>
	</form>
</div>
