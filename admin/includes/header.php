                        ...
                        <div class="sidebar-nav navbar-collapse">
                            <ul class="nav" id="side-menu">
                                ...
                                <li <?php echo (CURRENT_PAGE =="customers.php" || CURRENT_PAGE=="add_customer.php") ? 'class="active"' : '' ; ?>>
                                    <a href="#"><i class="fa fa-user-circle fa-fw"></i> Employee<span class="fa arrow"></span></a>
                                ...
                                <li>
                                    <a href="user_orders.php"><i class="fa fa-shopping-cart"></i> Orders</a>
                                </li>
                                <li>
                                    <a href="user_feedback.php"><i class="fa fa-circle"></i> Feedback</a>
                                </li>
                                <li>
