		...
		<div class="container">
			...
			<div class="company-contact">
				<div class="phone left">
					...
					<a href="tel:602-519-0450">1800-200-300</a>
				...
				<div class="email right">
					...
					<a href="mailto:company@example.com">Cleanzee@gmail.com</a>
					<span class="helper"></span>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="details clearfix">
				<div class="client left">
					<p>Invoice to:</p>
					<h4>Ms.&nbsp;<?php echo $_SESSION['name']; ?> Singh</h4>
					<br>
					<p>Service Address:<br>
						
				<?php
					$query="SELECT `address1`, `address2`, `city`, `state`, `postalcode` FROM `shippingadd` WHERE fname='".$_SESSION["name"]."'";
					$result=mysqli_query($conn,$query);
					while($row=mysqli_fetch_array($result))
					{
						echo $row['address1'].','.$row['address2'].','.$row['city'].','.$row['state'].','.$row['postalcode'];
					}	
				?>			
				...
				<div class="data right">
					<div class="title">Invoice 101</div>
					<div class="date">
						Date of Invoice: 20/03/2018<br>
					</div>
				</div>
			</div>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				while($row=mysqli_fetch_array($result))
				{
					...
					<script>
							...
							d.setMonth(d.getMonth() + <?php echo $row['frequence']; ?>);
					...
					<tr>
						...
						<th class="qty">Date & Time</th>
						<th class="unit">EXP. Month</th>
				...
				<tbody>
					...
					<tr>
						<td class="desc"><h3>'.$row['servicename'].'</h3></td>
						<td class="qty">'.$row['date'].'   '.$row['time'].'</td>
						<td class="unit"><script>document.write(date1)</script></td>
