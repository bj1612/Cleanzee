		...
		if($_SESSION['name'])
		{
			...
			?>
				...
				<?php
					if($row['data']==0)
					{
						echo "<script>document.getElementById('cartdata').innerHTML = '<center><h1>Please add service in your cart<h1><center>';</script>";
					}
			}
		}
		else
		...
		<div class="ui text container">
			...
			<div class="ui bottom attached segment">
				<table cellpadding="7" align="center">
					<tr>
						<td><label id="lbl-for-size">Select Furniture:</label></td>
						<td>
							<div id="house-size">
									<div class="field">
										<div class="ui checkbox">
											<input type="radio" name="housesizeradio" value="999" >
											<label>1-Bed,2-Chair & Dining Table,1-Sofa</label>
										</div>
									</div>
									<div class="field">
										<div class="ui checkbox ">
											<input type="radio" name="housesizeradio" value="1099">
											<label>1-Bed,2-Chair & Dining Table,2 Sofa</label>
										</div>
									</div>
									<div class="field">
										<div class="ui checkbox ">
											<input type="radio" name="housesizeradio" value="1299">
											<label>2-Bed,4-Chair & Dining Table,2-3 Sofa</label>
										</div>
									</div>
									<div class="field">
										<div class="ui checkbox ">
											<input type="radio" name="housesizeradio"  value="1699" >
											<label>2-3 Bed,6-Chair & Dining Table,2-3 Sofa</label>
										</div>
									</div>
							</div>
						</td>
